...
// Render creates /opt/render/project/src/ as base
// So we just need ./src from backend folder
const searchPaths = [
  path.join(__dirname, 'src'),                    // Standard: ./src
  path.resolve(__dirname, 'src'),                 // Absolute: /opt/render/project/src/backend/src
];
